...
class DatabaseInterfaceTest extends TestCase
{
    ...
    public function testSelectQueryById()
    {
        $date=date("Y-m-d");
        $cartellaClinica=new CartellaClinica(1,$date,"2","3","Patologia","Farmaco","RSSMRC80R12H703U","NSTFNC94M23H703G");
        $select=DatabaseInterface::selectQueryById(array("id_cartella_clinica"=>$cartellaClinica->getId()),CartellaClinica::$tableName);
    ...
    {
        $result=DatabaseInterface::selectDinamicQuery(array("n_sedute"),array("id_pacchetto"=>1),Pacchetto::$tableName);
