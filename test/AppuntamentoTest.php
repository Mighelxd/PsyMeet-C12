...
class AppuntamentoTest extends TestCase
{
	...
	{
		$app = new Appuntamento(1, '2022-01-20', '12:30:00', 'desc', 'RSSMRC80R12H703U', 'NSTFNC94M23H703G');
	...
	{
		$app = new Appuntamento(1, '2022-01-20', '12:30:00', 'desc', 'RSSMRC80R12H703U', 'NSTFNC94M23H703G');
		self::assertEquals('12:30:00', $app->getOra());
	}
	...
	public function testSetOra()
	{
		$app = new Appuntamento(1, '2022-01-20', '12:30:00', 'desc', 'RSSMRC80R12H703U', 'NSTFNC94M23H703G');
		$app->setOra('15:00:00');
		self::assertEquals('15:00:00', $app->getOra());
	}
