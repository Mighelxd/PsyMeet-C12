  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Scheda Primo Colloquio</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Scheda Primo Colloquio</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        <span style="color:red"><?php if (isset($_SESSION['eccspq'])) {
						echo $_SESSION['eccspq'];
					} ?></span>
