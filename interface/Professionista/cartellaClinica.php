                ...
                <form role="form">
                  <div class="card-body">
                    ...
                    <div class="form-group">
		    		  ...
		    		  <label for="sesso">F</label>
		    		  <input type="radio" name="sesso" value="Femmina">
                    </div>
                    <div class="form-group">
                       <label for="professione">Professione</label>
	   				   <input type="text" id="professione" name="profes" placeholder="inserisci professsione...">
                    </div>
                    <div class="form-group">
                       <label for="istruzione">Istruzione</label>
	    			   <input type="text" id="istruzione" name="istr" placeholder="inserisci istruzione...">
                    </div>
                    <div class="form-group">
                       <label for="statoFamiliare">Stato Familiare</label>
	    			   <textarea id="statoFamiliare" name="statoF" placeholder="scrivi..." style="height:200px"></textarea>
                    </div>
                    <div class="form-group">
                       <label for="diagnosi">Diagnosi</label>
	    			   <textarea id="diagnosi" name="diagn" placeholder="scrivi..." style="height:200px"></textarea>
                    </div>
                    <div class="form-group">
                       <label for="trattamento">Trattamento</label>
	    			   <textarea id="trattamento" name="tratta" placeholder="scrivi..." style="height:200px"></textarea>
                    </div>
                    ...
                    <div class="panel">
                      <div class="form-group">
  	    				...
  	    				<textarea id="farmaci" name="farma" placeholder="scrivi..." style="height:200px"></textarea>
                      </div>
                      <div class="form-group">
                          <label for="umore">Qualità dell'umore</label>
  	    				<textarea id="umore" name="umo" placeholder="scrivi..." style="height:200px"></textarea>
                      </div>
                      <div class="form-group">
                          <label for="patologia">Patologie pregresse psichiche/fisiche</label>
  	    				<textarea id="patologia" name="patol" placeholder="scrivi..." style="height:200px"></textarea>
                      </div>
                      <div class="form-group">
                          <label for="relazioni">Qualità relazioni affettive</label>
  	    				<textarea id="relazioni" name="relaz" placeholder="scrivi..." style="height:200px"></textarea>
                      </div>
                    </div>
                  </div>
                  <!-- /.card-body -->
