...
insert into paziente(cf,nome,cognome,data_nascita,email,telefono,passwor,indirizzo,istruzione,lavoro,difficol_cura,videochiamata) value('NSTFNC94M23H703G','Francesco','Nesta','1994-08-23','franconesta@gmail.it','089255788','66744B081EBFE95452B96BE2CA6554ED','via casa, 10','Diploma','Impiegato','3',false);

insert into terapia(data,descrizione,cf_prof,cf) value('2021-10-02','cognitivo comportamentale','RSSMRC80R12H703U','NSTFNC94M23H703G');

insert into schedaPrimoColloquio(data,problema,aspettative,motivazione,obiettivi,cambiamento,id_terapia,tipo) value('2021-10-02','Disturbo comportamentale','Il paziente vuole superare la paura del buio','NA.','Aiutare il paziente a superare il suo disturbo','NA.','1','Scheda Primo Colloquio');

insert into schedaAssessmentGeneralizzato(data,autoreg_positivi,autoreg_negativi,cognitive_positivi,cognitive_negativi,self_management_positivi,self_management_negativi,sociali_positivi,sociali_negativi,id_terapia,tipo) value('2021-10-02','NA','NA','NA','NA','NA','NA','NA','NA','1','Scheda Assessment Generalizzato');

insert into schedaAssessmentFocalizzato(data,n_episodi,id_terapia,tipo) value('2021-10-02','1','1','Scheda Assessment Focalizzato');
...
insert into cartellaClinica(data_creazione,q_umore,q_relazioni,patologie_pregresse,farmaci,cf_prof,cf) value('2021-10-21','3','3','NA','NA','RSSMRC80R12H703U','NSTFNC94M23H703G');

insert into compito(data,effettuato,titolo,descrizione,svolgimento,correzione,cf_prof,cf) value('2021-10-21','1','Buio','NA', 'svolgimento1', 'correzione1', 'RSSMRC80R12H703U','NSTFNC94M23H703G');
